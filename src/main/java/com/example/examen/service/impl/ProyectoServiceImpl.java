...
import com.example.examen.controller.exceptions.ResourceValidationException;
...
import com.example.examen.mappers.ProyectoMapper;
import com.example.examen.repository.ClienteRepository;
import com.example.examen.repository.ColaboradorRepository;
import com.example.examen.repository.ProyectoRepository;
import com.example.examen.service.service.ProyectoService;
...
public class ProyectoServiceImpl implements ProyectoService {
    ...
    public ProyectoDTO findById(Long aLong) throws ServiceException {
        ...
        Proyecto proy = proyectoRepository.findById(aLong)
                .orElseThrow(() -> new ResourceNotFoundException("Proyecto no encontrada con ID: " + aLong));

        return proyectoMapper.toDTO(proy);
    }
